<%@ Page Title="" Language="C#" MasterPageFile="~/Assignment6.Master" AutoEventWireup="true" CodeBehind="Assignment5.aspx.cs" Inherits="Assignment_5.Sample.Assgnment5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: center; background-color: #FFFF00;">
            <asp:Table ID="Table1" runat="server" Width="100%" Height="60%" rules="all" HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" BorderColor="Black" Font-Names="Consolas" GridLines="Both">
            ...
            <br />
            <asp:ValidationSummary ID="ValidationSummary1" runat="server" Font-Names="Comic Sans MS" ForeColor="Red" Visible="True" style="text-align: left"/>
            <br />
        <div style="text-align: center">
            <asp:Button runat="server" HorizontalAlign="Right" Text="Submit" ID="btn1" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Height="35px" Width="80px" style="text-align: center"  OnClick="btn1_Click"/>
        </div>
