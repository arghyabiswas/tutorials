<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assignment_5.aspx.cs" Inherits="assignment_5.assignment_5" MasterPageFile ="~/assignment_6.Master" %>
   ...
   <asp:Content ID ="content1" ContentPlaceHolderID ="ContentPlaceHolder1" runat ="server">
    ...
    <div>
        ...
        <asp:Table ID="Table1" runat="server" HorizontalAlign ="Center" Height="36px" BackColor="White" >
              <asp:TableRow>
                <asp:TableCell>
                    First Name
                </asp:TableCell>
         ...
         <span style="text-align:center"><asp:Button ID="Button1" runat="server"  Text="Submit"  /></span> 
    </div>
