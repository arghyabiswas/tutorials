<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Assignment5.WebForm1" MasterPageFile="~/Assignment6.Master" %>
...
<asp:Content ID="asg5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Table runat="server" Height="312px" Width="719px" style="margin-left: 81px">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:TextBox ID="TextBoxLastName" runat="server" placeholder="Enter LastName"></asp:TextBox>
                    </asp:TableCell>
        ...
        <p>
            <asp:Button ID="ButtonSubmit" runat="server" BackColor="#3366FF" ForeColor="White" Text="Submit" BorderStyle="Inset" Height="35px" Width="86px" style="margin-left: 389px" OnClick="ButtonSubmit_Click" />
        </p>
