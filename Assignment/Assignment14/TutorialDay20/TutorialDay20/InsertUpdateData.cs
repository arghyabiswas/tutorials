    ...
    class InsertUpdateData
    {
        ...
        public static bool AddEditProject(int data)
        {
            ...
            try
            {
                ...
                //int a = 0;
                // SqlCommand insertCommand = new SqlCommand($"insert into Project(Name,Description,StartDate, EndDate,IsActive)values('{InsertUpdateData.name}', '{InsertUpdateData.desc}','{dtmstartDate}','{dtmendDate}','{InsertUpdateData.isActive}')",con);
