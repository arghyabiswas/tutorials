<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assignment5.aspx.cs" Inherits="WebApplication1.Sample.assignment5" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Table ID="Table1" runat="server" Width="100%" Style="margin-top: 10vh; background-color: beige;">
                <asp:TableHeaderRow>
