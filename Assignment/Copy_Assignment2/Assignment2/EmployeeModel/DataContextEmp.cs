...
{
    public static class DataContextEmp
    {
        static DataContextEmp()
        {
            Employees1 = new List<IEmployee>();
        ...
        public static List<IEmployee> Employees1 { get; private set; }
    }
 }
